    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proteins', models.DecimalField(decimal_places=2, default=0, max_digits=6, validators=[django.core.validators.MinValueValidator(0)])),
                ('fats', models.DecimalField(decimal_places=2, default=0, max_digits=6, validators=[django.core.validators.MinValueValidator(0)])),
                ('saturated_fats', models.DecimalField(decimal_places=2, default=0, max_digits=6, validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('sugars', models.DecimalField(decimal_places=2, default=0, max_digits=6, validators=[django.core.validators.MinValueValidator(0)])),
                ('fiber', models.DecimalField(decimal_places=2, default=0, max_digits=6, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('manager', 'Manager'), ('table', 'Table'), ('kitchen', 'Kitchen'), ('other', 'Other')], default='other', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step', models.DecimalField(decimal_places=1, default=1, max_digits=2, validators=[django.core.validators.MinValueValidator(0.05)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_status', models.CharField(choices=[('pending', 'Pending'), ('cooking', 'Cooking'), ('ready', 'Ready'), ('delivered', 'Delivered'), ('cancelled', 'Cancelled'), ('problem', 'Problem')], default='pending', max_length=20)),
                ...
                ('service', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(10)])),
                ...
                ('nutritional_value', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='core.nutritionalvalue')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='first_order', to=settings.AUTH_USER_MODEL)),
                ('user_last_update', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='last_update', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='OrderHistory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_status', models.CharField(choices=[('pending', 'Pending'), ('cooking', 'Cooking'), ('ready', 'Ready'), ('delivered', 'Delivered'), ('cancelled', 'Cancelled'), ('problem', 'Problem')], max_length=20)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_history_user', to=settings.AUTH_USER_MODEL)),
                ('user_last_update', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_history_last_update', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('price_multiplier', models.DecimalField(decimal_places=2, default=3.0, max_digits=5, validators=[django.core.validators.MinValueValidator(0)])),
                ('custom_price', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('nutritional_value', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product', to='core.nutritionalvalue')),
            ],
        ),
        migrations.CreateModel(
            name='OrderProduct',
