...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(15)])),
                ('tax', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(10)])),
                ('can_order', models.BooleanField(default=True)),
                ('timezone', models.CharField(default='Asia/Makassar', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.CharField(choices=[('offline', 'Offline'), ('takeaway', 'Take Away'), ('delivery', 'Delivery')], default='offline', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.CharField(choices=[('offline', 'Offline'), ('takeaway', 'Take Away'), ('delivery', 'Delivery')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_type', models.CharField(choices=[('dish', 'Dish'), ('drink', 'Drink'), ('dessert', 'Dessert')], default='dish', max_length=10)),
                ('name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_discount', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='used_for_order', to='core.order')),
                ('promo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='used_promo', to='core.promo')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='used_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='promo_usage',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='used_promos', to='core.promousage'),
        ),
        migrations.CreateModel(
            name='Purchase',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paid', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('what_bought', models.TextField(blank=True, null=True)),
                ('admin_note', models.TextField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='purchase_creator', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='promo',
            index=models.Index(fields=['active_from', 'active_until'], name='core_promo_active__2ef1dd_idx'),
        ),
        migrations.AddIndex(
            model_name='promo',
            index=models.Index(fields=['promo_code'], name='core_promo_promo_c_0543d4_idx'),
        ),
        migrations.AddIndex(
            model_name='promo',
            index=models.Index(fields=['active_from', 'active_until', 'is_enabled', 'used_count', 'usage_limit'], name='core_promo_active__4ea72e_idx'),
        ),
        migrations.AddIndex(
            model_name='order',
